...
public class Ejercicios {
    ...
    public double ejercicio3(double precio) {
        // Implementar solución Implementar función que calcula el precio final tras aplicar un descuento del 10% si el precio original es igual o superior a 50000.
        double descuento = 0;
        if (precio >= 50000) {
    ...
    public String ejercicio4(int tipoFigura, double ladoCuadrado, double baseTriangulo, double alturaTriangulo,
            double radioCirculo) {
        // Implementar solución Implementar que función calcula el área de un cuadrado, triángulo o círculo según el tipo de figura ingresada y las dimensiones correspondientes.
        double area = 0;
        switch (tipoFigura) {
            case 1:
    ...
    public int ejercicio5(int num1, int num2, int num3) {
        // Implementar solución Implementar función que devuelve el menor de tres enteros dados.
        int menor = num1;
        if (num2 < menor) {
            menor = num2;
        }
